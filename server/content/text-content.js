...
const schema = Joi.object().keys({
  ...
  uniqueIdentificationMark: Joi.object({
    ...
    errorMessages: Joi.object({
      ...
      "error.inputCR.string.pattern.base": Joi.string().required(),
      ...
      "error.inputCB.string.pattern.base": Joi.string().required(),
      ...
      "error.inputHU.string.pattern.base": Joi.string().required(),
      ...
      "error.inputLB.string.pattern.base": Joi.string().required(),
      ...
      "error.inputMC.string.pattern.base": Joi.string().required(),
      ...
      "error.inputOT.string.pattern.base": Joi.string().required(),
      ...
      "error.inputSN.string.pattern.base": Joi.string().required(),
      ...
      "error.inputTG.string.pattern.base": Joi.string().required(),
      ...
      "error.inputSR.string.pattern.base": Joi.string().required(),
      ...
      "error.inputSI.string.pattern.base": Joi.string().required()
    }).required()
  }).required(),
