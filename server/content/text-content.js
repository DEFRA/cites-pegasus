...
const schema = Joi.object().keys({
  ...
  originPermitDetails: Joi.object({
    ...
    dividerText: Joi.string().required(),
    checkboxLabelNotKnownImport: Joi.string().required(),
    checkboxLabelNotKnownNotImport: Joi.string().required(),
    errorMessages: Joi.object({
  ...
  applicationSummary: Joi.object({
    ...
    rowTextIsExportOrReexportSameAsCountryOfOrigin: Joi.string().required(),
    headingOriginPermitDetails: Joi.string().required(),
    headingExportPermitDetails: Joi.string().required(),
    headingImportPermitDetails: Joi.string().required(),
