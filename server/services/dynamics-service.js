...
async function getSubmissions(request, contactId, permitTypes, statuses, startIndex, pageSize, searchTerm) {
  const submissions = [
    ...
    { submissionId: 'EF9019', contactId: '9165f3c0-dcc3-ed11-83ff-000d3aa9f90e', status: 'issued', dateSubmitted: '2022-03-1T22:59:59.000Z', permitType: 'import' },
    ...
    { submissionId: 'MN5659', contactId: '9165f3c0-dcc3-ed11-83ff-000d3aa9f90e', status: 'in process', dateSubmitted: '2022-07-28T22:59:59.000Z', permitType: 'article10' },
    ...
    { submissionId: 'CD5677', contactId: '9165f3c0-dcc3-ed11-83ff-000d3aa9f90e', status: 'awaiting payment', dateSubmitted: '2022-11-01T09:35:12.000Z', permitType: 'export' },
    ...
    { submissionId: 'IJ2328', contactId: '9165f3c0-dcc3-ed11-83ff-000d3aa9f90e', status: 'awaiting reply', dateSubmitted: '2022-06-25T22:59:59.000Z', permitType: 'import' },
